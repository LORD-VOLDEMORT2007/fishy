...
function setup() {
  ...
  trex = createSprite(50,  height - 330, 20, 50);
  trex.addAnimation("running", trex_running);
  trex.scale = 0.18;

  trex1 = createSprite(50, height - 330, 20, 50);
    trex1.addAnimation("collided", trex_collided);
    trex1.scale = 0.5;
  
  ground = createSprite(200, 180, width + 1000, height);
  ...
  invisibleGround = createSprite(200, height - 330, width, 10);
